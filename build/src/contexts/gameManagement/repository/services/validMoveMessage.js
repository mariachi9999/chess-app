...
const returnPieceName_1 = require("../utils/returnPieceName");
const validMoveMessage = (newBoard) => {
    ...
    let piece_name = (0, returnPieceName_1.returnPiece)(piece);
    let move = `${player_color} player moves ${piece_name} from ${from} to ${to}.`;
    let capture = "";
    let capture_name;
    if (flags === "c") {
        capture_name = (0, returnPieceName_1.returnPiece)(captured);
        capture_name === "King"
